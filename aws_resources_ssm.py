...
# authenticate AWS
def connect_aws():
    global s3_client, ecr_client, rds_client, scr_client, ssm_client
...
def get_ecr_policy(name):
    ...
    try:
        ...
        return False
    ecr_principal_arns = response['Parameter']['Value']
    ECRPolicy = ECRPolicyPre + ecr_principal_arns + ECRPolicyPost
